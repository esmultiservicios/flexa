<div class="container-fluid">
	...
	<nav class="breadcrumb-container bg-white py-3 mb-4 shadow-sm">
		<div class="container-fluid">
			<ol class="breadcrumb mb-0">
				...
				<li class="breadcrumb-item active fw-bold">Categoría Productos</li>
			</ol>
		</div>
	</nav>
	...
	<div class="card mb-4">
        <div class="card-body">
            <form id="form_main_categorias">
                <div class="row">
                    <div class="col-md-3 col-sm-6 mb-3">
                        <div class="form-group">
                            <label class="small mb-1">Estado</label>
                            <select id="estado_categorias" name="estado_categorias" class="form-control selectpicker" title="Estado" data-live-search="true">
    ...
    <div class="card mb-4">
		<div class="card mb-4">
			<div class="card-header">
				<i class="fas fas fa-layer-group fa-lg mr-1"></i>
				Categoría Productos
			</div>
			<div class="card-body"> 
				<div class="table-responsive">
					<table id="dataTableConfCategorias" class="table table-header-gradient table-striped table-condensed table-hover" style="width:100%">
						<thead>
							<tr>
								<th>Categoría</th>						
								<th>Estado</th>	
