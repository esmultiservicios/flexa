	...
	<nav class="breadcrumb-container bg-white py-3 mb-4 shadow-sm">
        <div class="container-fluid">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active fw-bold">Planes</li>
            </ol>
        </div>
    </nav>  
    ...
    <div class="card mb-4">
		<div class="card mb-4">
			<div class="card-header">
				<i class="fas fa-globe fa-lg mr-1"></i>
				Planes
			</div>
			<div class="card-body"> 
				<div class="table-responsive">
					<table id="dataTablePlanes" class="table table-header-gradient table-striped table-condensed table-hover" style="width:100%">
						<thead>
							<tr>
								<th>Código</th>
								<th>Nombre</th>
